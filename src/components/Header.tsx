...
const ecosystemDomains = [
  ...
  { name: 'IoMarkets.com', subtitle: 'Advanced Cryptocurrency Trading Exchange', url: 'https://iomarkets.com', icon: '💹', current: true },
          ...
          <nav className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-cyan-400 -mt-0.5 uppercase tracking-wider font-bold">EXCHANGE</span>
              </div>
            </Link>
